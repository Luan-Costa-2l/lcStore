...
const Ads = () => {
  ...
  const adsAbortControllerRef = useRef<AbortController | null>(null);
  ...
  useEffect(() => {
    adsAbortControllerRef.current?.abort();
    adsAbortControllerRef.current = new AbortController();
    const signal = adsAbortControllerRef.current.signal;
